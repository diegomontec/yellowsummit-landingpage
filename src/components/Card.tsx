...
const Card = () => {
  return (
    <div className="relative align-middle text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 px-4 sm:px-6 md:px-12 w-full ">
      <div className="border-2 rounded-2xl border-[#eb9f1b]">
        ...
        />
        <div className="flex flex-col justify-center text-left p-4 sm:p-6 md:p-8 gap-2 sm:gap-3">
          <p className="text-lg sm:text-2xl md:text-3xl font-semibold">
            Viviane de Castro
          </p>
          <p className="text-base sm:text-lg md:text-xl text-[#eb9f1b]">
