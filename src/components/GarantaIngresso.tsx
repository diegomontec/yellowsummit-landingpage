...
const GarantaIngresso = () => {
    return (
      <section className="relative w-full py-24 h-screen flex flex-col items-center justify-center">
        <Image
        ...
        <div className="flex flex-col max-w-3xl relative text-center justify-center items-center gap-16 px-4">
          ...
          <Image
            ...
            height={120}
            priority
            className="w-48 sm:w-64 md:w-92 h-auto object-contain"
          />
        </div>
      </section>
    );
